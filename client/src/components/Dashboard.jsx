...
function Dashboard() {
  ...
  const tariffHighX = findNearestTime(electricityData, house?.tariff_high_start?.slice(0, 5))
  const tariffLowX = findNearestTime(electricityData, house?.tariff_low_start?.slice(0, 5))
